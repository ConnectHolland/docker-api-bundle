...
class RepositoryPermissionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'ConnectHolland\\DockerHubApiBundle\\Api\\Model\\RepositoryPermissions';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'ConnectHolland\\DockerHubApiBundle\\Api\\Model\\RepositoryPermissions';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \ConnectHolland\DockerHubApiBundle\Api\Model\RepositoryPermissions();
